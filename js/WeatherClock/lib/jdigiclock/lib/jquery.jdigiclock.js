...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                $this.currDate = '';
                $this.timeUpdate = '';
                $this.proxy= o.proxy?o.proxy:null;

                console.log('!00!');

                var html = '<div id="plugin_container">';
                html    += '<p id="left_arrow"><img src="lib/jdigiclock/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="lib/jdigiclock/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON( proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="lib/jdigiclock/images/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
